 ...
 */
final class Version20250114180353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD category_id INT NOT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD category VARCHAR(255) NOT NULL, DROP category_id');
    }
}
